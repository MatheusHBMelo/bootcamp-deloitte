...
// Versão 3 do CRUD feita na atividade 2, implementando POO e delegando função
// A partir da migração para Spring Boot, passou-se a chamar SistemaUsuarioApplication, com notação padrão do Spring Boot.
