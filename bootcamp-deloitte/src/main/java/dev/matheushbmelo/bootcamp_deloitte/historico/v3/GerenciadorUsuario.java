...
// Classe que contem a logica do CRUD de usuario, ela é requisitada por SistemaUsuario e manipula objetos da classe Usuario.
// A partir da migração para Spring Boot, passou-se a chamar UsuarioService e teve varias alterações nos métodos.
